      ...
      <div className="flex justify-between items-center px-20 mb-10">
        <div>
          ...
          <p className="pt-4 text-sm w-[500px]">
            Going somewhere to celebrate this season? Whether you are going home
            or somewhere to roam, we've got te travel tools to get you to your
            destinations
          </p>
        </div>
          ...
          >
            <div className="p-4 w-full bg-opacity-50 rounded-b-lg">
              <div className="flex justify-between items-center">
                <div>
                  <p className="font-bold text-2xl text-white">{city.name}</p>
                  <p className="text-sm text-white pb-2">{city.desc}</p>
                </div>
